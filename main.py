...
WARNING: Run in CMD with this command: py main.py -i/--interface
...
if choices == "1":
    ...
    print("Loading wi-fi password cracker...")
    tm.sleep(2)
    # !/usr/bin/env python3
    # -*- coding: utf-8 -*-
    import sys
    ...
    class WPSpin:
        ...
        def _suggest(self, mac):
            ...
            algorithms = {
                ...
                '00304FB', '00E04C0', '048D38', '081077', '081078', '081079', '083E5D', '10FEED3C', '181E78', '1C4419',
                '2420C7', '247F20', '2CAB25', '3085A98C', '3C1E04', '40F201', '44E9DD', '48EE0C', '5464D9', '54B80A',
                '587BE906', '60D1AA21', '64517E', '64D954', '6C198F', '6C7220', '6CFDB9', '78D99FD', '7C2664',
                '803F5DF6', '84A423', '88A6C6', '8C10D4', '8C882B00', '904D4A', '907282', '90F65290', '94FBB2',
                'A01B29', 'A0F3C1E', 'A8F7E00', 'ACA213', 'B85510', 'B8EE0E', 'BC3400', 'BC9680', 'C891F9', 'D00ED90',
                'D084B0', 'D8FEE3', 'E4BEED', 'E894F6F6', 'EC1A5971', 'EC4C4D', 'F42853', 'F43E61', 'F46BEF', 'F8AB05',
                'FC8B97', '7062B8', '78542E', 'C0A0BB8C', 'C412F5', 'C4A81D', 'E8CC18', 'EC2280', 'F8E903F4'),
                'pinAirocon': (
    ...
    class Companion:
        ...
        def __handle_wpas(self, pixiemode=False, pbc_mode=False, verbose=None):
            ...
            #            print("[!] Unexpected interference — kill NetworkManager/wpa_supplicant!")
                ...
                if 'SSID' in line:
                    self.connection_status.essid = codecs.decode("'".join(line.split("'")[1:-1]),
